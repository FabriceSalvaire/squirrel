...
# <visit_Typedef> typedef <visit_Struct> struct fz_pcl_options_s fz_pcl_options;

# <visit_Decl> <visit_Struct> struct fz_pcl_options_s
# {
#   <visit_Decl> <visit_IdentifierType> int features;
#   <visit_Decl> const <visit_IdentifierType> char *odd_page_init;
#   <visit_Decl> const <visit_IdentifierType> char *even_page_init;
#   <visit_Decl> <visit_IdentifierType> int tumble;
#   <visit_Decl> <visit_IdentifierType> int duplex_set;
#   <visit_Decl> <visit_IdentifierType> int duplex;
#   <visit_Decl> <visit_IdentifierType> int paper_size;
#   <visit_Decl> <visit_IdentifierType> int manual_feed_set;
#   <visit_Decl> <visit_IdentifierType> int manual_feed;
#   <visit_Decl> <visit_IdentifierType> int media_position_set;
#   <visit_Decl> <visit_IdentifierType> int media_position;
#   <visit_Decl> <visit_IdentifierType> int page_count;
# };

# <visit_Decl> <visit_IdentifierType> void fz_pcl_preset(
#   <visit_ParamList>
#     <visit_Decl> <visit_IdentifierType> fz_context *ctx,
#     <visit_Decl> <visit_IdentifierType> fz_pcl_options *opts,
#     <visit_Decl> const <visit_IdentifierType> char *preset);
...
class AsmAndAttributesMixin(object):
    ...
    def _generate_type(self, n, modifiers=[]):
        ...
        print('_generate_type')

        typ = type(n)
        #~ print(n, modifiers)

        if typ == c_ast.TypeDecl:
            print('  _generate_type 1')
            s = ''
