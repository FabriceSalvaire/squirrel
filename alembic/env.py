...
# Set sqlalchemy.url
config.set_main_option('sqlalchemy.url', 'sqlite:///' + str(Config.DataBase.document_database()))
...
declarative_base_cls, row_classes, table_classes = DocumentSqliteDataBase.build_tables()
